...
/// @desc Sends the command to the server with json_stringify()
/// @param {struct} CommandID
function net_cmd_send_struct(struct) {

	// Encode the content to JSON
	var contentToSend = json_stringify(struct);
